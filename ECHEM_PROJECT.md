...
- **General tab defaults** — linewidth=3, legend_size=40, grid X/Y=True, grid color=black, grid width=2, font title=80/label=60/tick=30, spacing title=40/label=40, cycle step=0.15 (other tabs keep original defaults)
