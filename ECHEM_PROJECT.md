...
- **Pair entry**: `{rpm_id, rpm_val, n2_short, o2_short, n2_path, o2_path, catalyst_id, df_n2, df_o2}` — df_n2/df_o2 are runtime-only (`_PAIR_RUNTIME`); stored by hash in session ZIP
